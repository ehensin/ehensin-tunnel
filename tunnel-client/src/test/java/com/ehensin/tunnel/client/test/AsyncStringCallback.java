...
public class AsyncStringCallback extends DefaultCallBack<String>{

	public AsyncStringCallback(Class<String> clazz) {
		super(clazz);
	}
	...
	public void callback(String srcCallId, Object object) {
		...
		System.out.println("===========src call id : " + srcCallId + ", " + object);
	}

	@Override
	public void exceptionCaught(String srcCallId, String errorCode,
			String errorDesc) {
		//System.out.println("===========src call id : " + srcCallId + ", " + errorDesc);
